...
export default function CoursesPage() {
  ...
  const filteredCourses = useMemo(() => {
    ...
    return items.filter((c) => c.level === filter);
  }, [items, filter]);
        ...
        <FadeIn>
          <div className="max-w-2xl mb-10">
            ...
            <p className="text-lg text-surface-500 dark:text-surface-400">
              ...
              daily — not career trainers. Small cohorts, real projects, actual
              feedback.
            </p>
          </div>
        </FadeIn>
          ...
          <div id="internship" className="mt-20 rounded-2xl bg-gradient-to-r from-brand-50 to-accent-50 dark:from-brand-950/30 dark:to-accent-950/30 border border-brand-100 dark:border-brand-900/30 p-8 sm:p-12">
            <div className="max-w-2xl">
              ...
              <p className="text-surface-600 dark:text-surface-400 mb-6">
                Our 3-month internship places you on actual client projects under
                senior mentorship. You&apos;ll write code that ships to production, sit
                in architecture reviews, and graduate with experience that matters
                on a resume. Stipend included.
              </p>
